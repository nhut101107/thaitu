...
export function emptyState(title, text, action = "") {
  return `<div class="empty-state"><span class="brand-mark">S</span><h3>${escapeHtml(title)}</h3><p>${escapeHtml(text)}</p>${action}</div>`;
}
