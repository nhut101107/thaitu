...
class MiniAppTest(unittest.TestCase):
    ...
    def test_frontend_nftoken_request_has_timeout_cleanup_and_idempotency(self):
        ...
        self.assertIn("modalSheet?.isConnected", views_source)
        self.assertIn('stateLabel.classList.add("error")', views_source)
        ...
        self.assertIn('shop-mmo-static-v9', Path("miniapp/sw.js").read_text(encoding="utf-8"))
        self.assertIn('views.js?v=20', Path("miniapp/assets/app.js").read_text(encoding="utf-8"))
        ...
        self.assertIn('Final dark-palette pass', theme_source)
        self.assertIn('background: #27272a !important', theme_source)
        ...
        self.assertIn('translateText(message)', Path("miniapp/assets/components.js").read_text(encoding="utf-8"))
        checks_css = Path("miniapp/assets/admin-extra.css").read_text(encoding="utf-8")
        self.assertIn('appearance: none', checks_css)
        self.assertIn('input[type="checkbox"]:checked', checks_css)
